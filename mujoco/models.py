...
class Reward(nn.Module):
    ...
    def init_weight(self, model_path):
        weights = dd.io.load(model_path)
        self.fc1.weight.data = torch.from_numpy(weights['fc1_weight'])
        self.fc1.bias.data = torch.from_numpy(weights['fc1_bias'])
        self.fc2.weight.data = torch.from_numpy(weights['fc2_weight'])
        self.fc2.bias.data = torch.from_numpy(weights['fc2_bias'])
        self.fc3.weight.data = torch.from_numpy(weights['fc3_weight'])
        self.fc3.bias.data = torch.from_numpy(weights['fc3_bias'])
