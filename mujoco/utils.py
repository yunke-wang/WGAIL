...
class Writer(object):
    def __init__(self, env, seed, epoch, traj_size, folder='PU_log', pbound='0.0'):
        ...
        self.fname = '{}_{}_{}_{}{}.csv'.format(env, seed, epoch, traj_size, pblabel)
        self.folder = folder
    ...
    def log_dist(self, epoch, dist):
        with open(self.folder + '/' + self.fname, 'a') as f:
            f.write('{},{}\n'.format(epoch, dist))

    def log(self, epoch, reward, nor_reward, dist):
        with open(self.folder + '/' + self.fname, 'a') as f:
            f.write('{},{},{},{}\n'.format(epoch, reward, nor_reward, dist))
